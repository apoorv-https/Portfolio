...
const EMAIL = "k.apoorvtiwari@gmail.com";
        ...
        <AnimatePresence>
            {open && (
                <>
                    ...
                    >
                        <div className="relative w-full max-w-sm rounded-2xl dark:border dark:border-d-border border border-l-border dark:bg-d-card bg-l-card p-7 shadow-[0_0_80px_0px_rgba(129,140,248,0.08)] overflow-hidden">
                            ...
                            <p className="mb-6 font-mono text-[11px] dark:text-d-accent text-l-accent border dark:border-d-accent/20 border-l-accent/20 dark:bg-d-accent/5 bg-l-accent/5 rounded-lg px-3 py-2 leading-relaxed">
                            ...
                            {/* LinkedIn row */}
                            <a
                                href="https://www.linkedin.com/in/apoorv-tiwari-966479324/"
                                target="_blank"
